    ...
    guides: [
      {
        ...
        videoSrc: publicAsset('videos/GCash.mp4'),
      },
      {
        id: 'maya',
        title: 'Maya',
    ...
    guides: [
      {
        ...
        videoSrc: publicAsset('videos/Shopee.mp4'),
      },
      {
        id: 'lazada',
        title: 'Lazada',
        ...
        videoSrc: publicAsset('videos/Lazada.mp4'),
      },
      {
        ...
        videoSrc: publicAsset('videos/FB Marketplace.mp4'),
      },
    ],
  },
  'social-email': {
    ...
    guides: [
      {
        ...
        videoSrc: publicAsset('videos/FB Post.mp4'),
      },
      {
        id: 'facebook-page',
        ...
        videoSrc: publicAsset('videos/FB Page.mp4'),
      },
      {
        id: 'gmail',
        title: 'Gmail',
        ...
        videoSrc: publicAsset('videos/Gmail.mp4'),
      },
    ],
  },
  messaging: {
    ...
    guides: [
      {
        ...
        videoSrc: publicAsset('videos/Messenger.mp4'),
      },
      {
        id: 'viber',
        title: 'Viber',
        ...
        videoSrc: publicAsset('videos/Viber.mp4'),
      },
    ],
  },
  'job-board': {
    ...
    guides: [
      {
        ...
        videoSrc: publicAsset('videos/LinkedIn.mp4'),
      },
      {
        id: 'jobstreet',
        title: 'Jobstreet',
        ...
        videoSrc: publicAsset('videos/Jobstreet.mp4'),
      },
      {
        id: 'upwork',
        title: 'Upwork',
        ...
        videoSrc: publicAsset('videos/Upwork.mp4'),
      },
    ],
  },
  workplace: {
